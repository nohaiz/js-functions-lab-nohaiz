...
const maxOfTwoNumbers = (x, y) => {
  ...
  console.log('Exercise 1 Result:', maxOfTwoNumbers(11, 11));
...
console.log('Exercise 3 Result:', isCharAVowel("aaa"));
...
console.log('Exercise 6 Result:', maxOfThree(50, 10, 80));
...
function calculateTip (bill,tipPercent) {
    return Math.round(bill*(tipPercent/100));
}
